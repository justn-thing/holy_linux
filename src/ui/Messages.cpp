...
namespace msg {
    ...
    constexpr std::string_view startupcfg_not_exist = "Startup config file does not exist, creating it...\n\n";
    ...
    constexpr std::string_view copy_into_descendant = "Cannot copy a file into its descendant.\n";
